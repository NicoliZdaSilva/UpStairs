 ...
 * @author thaia
 */
public class ViewCadastroProf extends javax.swing.JFrame {

    /**
     * Creates new form ViewCadastroProf
     */
    public ViewCadastroProf() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewCadastroProf.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewCadastroProf().setVisible(true);
            }
        });
    }
